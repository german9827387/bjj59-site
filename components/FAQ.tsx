...
const faqs = [
  ...
  },
  {
    ...
    a: "Да, по любому направлению — джиу-джитсу, борьба, бокс, ММА. Разовое занятие один на один — 1800 ₽, блок из 10 занятий — 14 000 ₽, это 1400 ₽ за тренировку. Можно заниматься вдвоём с другом или супругом: сплит на 10 занятий выходит 800 ₽ с человека. Тренера и удобное время подберём при записи.",
    tag: "Персонально",
  },
  {
