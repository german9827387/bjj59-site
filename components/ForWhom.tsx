...
const tabs: Tab[] = [
  ...
  },
  {
    ...
    items: [
      {
        num: "01",
        title: "Вместе, а не рядом",
        desc: "Папа и ребёнок редко проводят время вдвоём из-за работы, школы и гаджетов. На занятиях вы учитесь, играете и развиваетесь вместе, а не просто сидите рядом.",
      },
      {
        num: "02",
        title: "Здоровье и энергия для всей семьи",
        desc: "Ребёнок становится сильным и ловким, папа — тоже активен и снимает стресс. Вместе развиваете выносливость, координацию и уверенность через движение и единоборства.",
      },
      {
        num: "03",
        title: "Папа — пример, а не зритель",
        desc: "Тренируетесь вместе с нуля — и ребёнок видит характер отца, который не боится меняться. Ваш пример становится для него вдохновением.",
      },
    ],
  },
];
