...
const tabs = [
  {
    ...
    items: [
      {
        num: "01",
        title: "Здоровье после офиса",
        desc: "Целый день за компьютером? Приходи размять спину, суставы и снять зажимы. Уходишь бодрым — не «разбитым».",
      },
      {
        num: "02",
        title: "Стресс и «перезагрузка головы»",
        desc: "Устал от дедлайнов и постоянного напряжения? За час на ковре забываешь о любых проблемах — единоборства перезагружают голову лучше любого отпуска.",
      },
      {
        num: "03",
        title: "Похудеть и форма",
        desc: "Сжечь лишний жир, подтянуть тело и наконец увидеть мышцы — без скучных дорожек и тренажёров.",
      },
    ],
  },
  {
    ...
    items: [
      {
        num: "01",
        title: "Самооборона без риска",
        desc: "Ваш ребёнок научится уверенно защищаться — без жёстких спаррингов и травм. Только правильная техника, поддержка тренера и уверенность в себе.",
      },
      {
        num: "02",
        title: "Энергия в дело, а не в драки",
        desc: "Гиперактивный дома и в школе? Направим энергию в тренировки: дисциплина и сила характера вместо капризов и конфликтов.",
      },
      {
        num: "03",
        title: "Здоровье и осанка с детства",
        desc: "Никакой сутулости от гаджетов и лишнего веса. Крепкое тело, сильная спина и привычка к движению — фундамент на всю жизнь.",
      },
    ],
  },
  {
